<form method="POST" action="/oop_project_2/public/index.php?action=store">
    <div class="mb-3">
        ...
        <input placeholder="Arisu" name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">

    </div>
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Student's Surname</label>
        <input placeholder="Sakayanagi" name="surname" type="text" class="form-control" id="exampleInputPassword1">
    </div>
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Student's Grade</label>
        <input placeholder="2-A" name="grade" type="text" class="form-control" id="exampleInputPassword1">
    </div>
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Student's Academic Level</label>
        <input placeholder="A+ (Genius)" name="academic_level" type="text" class="form-control" id="exampleInputPassword1">
    </div>
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Student's ID</label>
        <input placeholder="S01T004737" name="student_id" type="text" class="form-control" id="exampleInputPassword1">
    </div>
